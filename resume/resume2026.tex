...
\begin{document}
	...
	\resumeItem{}{Перевёл 23 интеграции low-code платформы на новое API, обеспечив переход бухгалтерии. Проверил e2e на QA-контуре}
	\resumeItem{}{Настроил алерты, оптимизировал запрос и добавил расширения в PostgreSQL}
	...
	\resumeItem{}{Обосновал команде интеграцию с Rust-реализацией Dragonfly вместо согласованной ранее Go: с версии 2026 она основная}
	...
	\resumeItem{}{Нагрузочное тестирование в k8s: 100 образов от 1 МБ до 5 ГБ, на 20\% быстрее Podman}
	...
	\textbf{Технологии и инструменты}{: Git, Docker, PostgreSQL, Kafka, Kubernetes, REST API, gRPC, Grafana, Prometheus, Gradle, Cats Effect} \\%Nginx, k6, p2p, ZIO, FS
