...
\begin{document}
	...
	\resumeItem{}{Создал и протестировал 23 интеграции для low-code платформы, обеспечив переход на новое API бухгалтерии}
	...
	{Daemon на Java для p2p-загрузки OCI/Docker образов \textit{независимый} от container engine}{Индивидуальный проект}
	\resumeItemListStart
	...
	\textbf{Frameworks}{: Spring Boot, JUnit, Mockito} \\
	\textbf{Технологии и инструменты}{: Git, Docker, PostgreSQL, Kafka, Kubernetes, Grafana, Prometheus, Gradle, Cats Effect} \\%Nginx, k6, p2p, ZIO, FS
