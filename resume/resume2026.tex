...
\begin{document}
	...
	Архитектура компьютера и операционные системы, Java, Scala, Kotlin, C++
	Алгоритмы и структуры данных, Компьютерные сети, функциональное программирование, базы данных, архитектура ПО
	...
	{Daemon на Java для p2p-загрузки OCI/Docker образов \textit{независимое} от container engine}{Индивидуальный проект}
	\resumeItemListStart
	...
	\resumeItemListStart
	\resumeItem
	{Генерация городов и оппонентов, поведение врагов, виджеты армии ИИ-оппонентов;  туман войны и сражения}
	\resumeItemListEnd
...
\resumeItemListEnd
	...
	%-----------PROGRAMMING SKILLS-----------
	\section{Навыки}
	\textbf{Языки}{:Java, Scala, средне: (Kotlin, Python, C++)} \\
	\textbf{Frameworks}{: SpringBoot, JUnit, Mockito} \\
	\textbf{Технологии и инструменты}{:Git,Docker, PostgreSQL, Kafka, Kubernetes, Grafana, Prometeus, Gradle,Cats Effect} \\%Nginx, k6, p2p, ZIO, FS
