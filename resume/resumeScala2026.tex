...
\begin{document}
	...
	\begin{center}
		\textbf{\Large \scshape Усатов Павел} \textbf{\Large $|$ Scala Backend Developer} \\ \vspace{1pt}
	...
	Функциональное программирование, Scala, Java, Kotlin, C++, базы данных,
	алгоритмы и структуры данных, компьютерные сети, архитектура компьютера и операционные системы, архитектура ПО
    ...
    \resumeItemListEnd
	\textbf{Технологии}: Scala, Cats Effect, http4s, PostgreSQL, Kanban, Kafka, Docker, Typescript, ELK
	\resumeSubheading
	...
	%\resumeItemListEnd
	\par\noindent\textbf{Технологии}:  Scala, fs2, Go,
	...
	%-----------PROGRAMMING SKILLS-----------
	\section{Навыки}
	\textbf{Языки}{: Scala, Java, Kotlin} \\ %, Python, C++)} \\
	\textbf{Frameworks}{: Cats Effect, ZIO, Spring Boot, JUnit, Mockito} \\
