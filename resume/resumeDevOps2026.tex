...
\begin{document}
	...
	\resumeItem{}{Helm-чарт riid-observer: VictoriaMetrics, Grafana, kube-state-metrics, RBAC}
	\resumeItem{}{12 нод, 100 образов от 1 МБ до 5 ГБ: на 20\% быстрее Podman}
	\resumeItemListEnd
	...
	\resumeItemListStart
	\resumeItem{}{Релизы в GitLab: merge request, ревью, зелёный пайплайн, автовыкат на прод}
	\resumeItem{}{Алерты на БД, расширения PostgreSQL, e2e на QA-контуре, разбор багов по ELK}
	\resumeItemListEnd
	...
	\resumeItemListStart
	\resumeItem{}{Ansible-роли с тегами, ansible-vault, прод и тест - разные группы инвентаря}
	\resumeItem{}{Сервис без root: свой пользователь, ProtectSystem=strict, NoNewPrivileges}
	\resumeItem{}{certbot: pre/post-хуки освобождают порт 80, renewal-хук возвращает ACL}
	\resumeItem{}{Nginx единственный на 443, маршрутизация по SNI на два домена}
	\resumeItemListEnd
	...
	%-----------SKILLS-----------
	\section{Навыки}
	\textbf{Kubernetes и контейнеры}{: DaemonSet, ConfigMap, RBAC, Helm, Docker, Compose, Podman} \\
	...
	\textbf{Данные и языки}{: PostgreSQL, Kafka, gRPC, Go, Python, Java, Scala}
