...
\begin{document}
	...
	{Миграция документов с long на uuid}{Продуктовая команда документооборота}
	\resumeItemListStart
	\resumeItem{}{Версионировал эндпоинты и катил через GitLab CI, не ломая мобильные клиенты}
	\resumeItem{}{Перевёл 23 low-code интеграции на новое API: бухгалтерия перешла, e2e на QA}
	\resumeItem{}{Под миграцию: алерты на БД, оптимизация запроса, расширения PostgreSQL}
	\resumeItem{}{Починил генерацию документов: вернул столбец статистики во внешнем сервисе}
	\resumeItemListEnd
