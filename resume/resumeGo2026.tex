...
\begin{document}
	...
	\resumeItem{}{Разобрал Go- и Rust-клиенты Dragonfly, обосновал команде Rust: Go-версия не поддерживается с 2026}
	\resumeItem{}{Модульная архитектура: CLI $\rightarrow$ dispatcher $\rightarrow$ registry/cache/p2p $\rightarrow$ adapters для Podman, Porto, Docker}
	...
	\resumeSubHeadingListStart
	\resumeSubheading
	{\ulhref{https://github.com/UsatovPavel/PRAssign}{\textbf{PRAssign}} $|$ \normalfont{\emph{Go-сервис управления code review}}}{ноябрь 2025 - январь 2026}
	{REST API на Gin: команды, пользователи, пул-реквесты, назначение ревьюеров и статистика}{Индивидуальный проект}
	\resumeItemListStart
	\resumeItem{}{Слоистая архитектура: handler $\rightarrow$ service $\rightarrow$ repository на pgx, конфигурация viper, JWT с проверкой прав}
	\resumeItem{}{Асинхронный пайплайн: Go API $\rightarrow$ Kafka (sarama) $\rightarrow$ \ulhref{https://github.com/UsatovPavel/AsyncFactorial}{Scala-consumer} $\rightarrow$ Kafka $\rightarrow$ Go-consumer $\rightarrow$ PostgreSQL}
	\resumeItem{}{Nginx балансирует реплики сервиса: повтор по 502/503/504, keepalive, вывод упавшего бэкенда}
	\resumeItem{}{Пирамида тестов: интеграционные, e2e, smoke, stress; миграции golang-migrate, нагрузка k6}
	\resumeItemListEnd
	...
	\resumeItemListStart
	\resumeItem{}{Общие задания, статистика, достижения, push-уведомления; интеграция ChatGPT и Whisper}
	\resumeItemListEnd
	...
	{Учебные задания}{}{}{}
	\resumeItemListStart
	\resumeItem{Scala}{\ulhref{https://github.com/UsatovPavel/ZIO-Notification-Service}{ZIO REST API} для уведомлений с учётом часовых поясов}
	\resumeItem{Python}{\ulhref{https://github.com/UsatovPavel/Usatov-FL-HSE/tree/task4-dev}{ANTLR-парсер} регулярных выражений}
